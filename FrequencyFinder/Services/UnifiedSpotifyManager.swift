...
private struct FlexibleSpotifyTrack: Codable, Identifiable {
    let id: String
    let name: String
    let popularity: Int?
...
private struct FlexibleSpotifyArtist: Codable, Identifiable {
    let id: String
    let name: String
    let popularity: Int?
...
private struct FlexibleSpotifyAlbum: Codable {
    let id: String
    let name: String
    let images: [SpotifyImage]?
...
private struct FlexibleSpotifyPlayHistory: Codable, Identifiable {
...
private struct FlexibleSpotifyContext: Codable {
...
private struct FlexibleSpotifyRecentlyPlayedResponse: Codable {
...
private struct FlexibleSpotifyTopItemsResponse<T: Codable>: Codable {
